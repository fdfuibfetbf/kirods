...
const KnowledgeBase: React.FC = () => {
  ...
  return (
    <>
      ...
      {showHomepage && (
        <SEOHead
          title="Kirods Hosting Knowledge Base - Web Hosting Support & Guides"
          description="Comprehensive web hosting guides, tutorials, and support articles for cPanel, WordPress, domains, SSL certificates, and more."
          keywords="web hosting, cPanel, WordPress, domains, SSL, hosting support, tutorials, guides"
          ogType="website"
        />
      )}

      {/* SEO Head for category pages */}
      {showCategoryView && selectedCategoryInfo && (
        <SEOHead
          title={`${selectedCategoryInfo.name} - Kirods Hosting Knowledge Base`}
          description={selectedCategoryInfo.description || `Browse all ${selectedCategoryInfo.name} guides and tutorials for web hosting support.`}
          keywords={`${selectedCategoryInfo.name.toLowerCase()}, web hosting, tutorials, guides`}
          category={selectedCategoryInfo}
          ogType="website"
        />
      )}

      {/* SEO Head for search results */}
      {searchQuery && (
        <SEOHead
          title={`Search Results for "${searchQuery}" - Kirods Hosting Knowledge Base`}
          description={`Find articles and guides related to "${searchQuery}" in our comprehensive web hosting knowledge base.`}
          keywords={`${searchQuery}, web hosting, search, tutorials, guides`}
          ogType="website"
        />
      )}
