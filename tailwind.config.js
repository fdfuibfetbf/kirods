  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-primary-soft': 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 50%, #bbf7d0 100%)',
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
      },
      boxShadow: {
        'soft': '0 2px 8px 0 rgba(0, 0, 0, 0.08), 0 1px 3px 0 rgba(0, 0, 0, 0.06)',
        'medium': '0 8px 25px -5px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
        'large': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
        'green': '0 8px 30px -5px rgba(34, 197, 94, 0.3), 0 15px 15px -5px rgba(34, 197, 94, 0.15)',
        'xl-green': '0 25px 50px -12px rgba(34, 197, 94, 0.25)',
      ...
      animation: {
        ...
        'pulse-green': 'pulseGreen 3s infinite',
